...
rquery: rquery.o commfuncs.o querierc.o parser.o expression.o filter.o
	g++ -std=c++11 -L /lib/x86_64-linux-gnu -lboost_regex -I /usr/lib/boost/include -L /usr/lib/boost/lib rquery.o commfuncs.o function.o expression.o filter.o parser.o querierc.o -o rq
install:
