...
{
  analyzedPos = 0;
  vector<string> ParserC::junctionWords.push_back("AND"); vector<string> ParserC::junctionWords.push_back("OR");
  vector<string> ParserC::junctionSplitors.push_back(" AND ");vector<string> ParserC::junctionSplitors.push_back(" OR ");
  vector<string> ParserC::comparators.push_back("=");vector<string> ParserC::comparators.push_back("!=");vector<string> ParserC::comparators.push_back(">=");vector<string> ParserC::comparators.push_back("<=");vector<string> ParserC::comparators.push_back(">");vector<string> ParserC::comparators.push_back("<"); // ">=", "<=" should be before ">", "<"
}
